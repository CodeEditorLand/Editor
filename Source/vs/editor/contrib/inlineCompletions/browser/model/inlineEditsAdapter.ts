			...
			autorunWithStore((reader, store) => {
				...
				store.add(
					this._languageFeaturesService.inlineCompletionsProvider.register(
						...
						new (class
							implements
								InlineCompletionsProvider<InlineCompletionsAndEdits>
						{
							...
							): Promise<InlineCompletionsAndEdits> {
