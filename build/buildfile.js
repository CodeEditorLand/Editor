...
function createEditorWorkerModuleDescription(name) {
	return createModuleDescription(name, [
		"vs/base/common/worker/simpleWorker",
		"vs/editor/common/services/editorSimpleWorker",
	]);
}

exports.workerEditor = createEditorWorkerModuleDescription(
	"vs/editor/common/services/editorSimpleWorkerMain",
);
exports.workerExtensionHost = createEditorWorkerModuleDescription(
	"vs/workbench/api/worker/extensionHostWorkerMain",
);
exports.workerNotebook = createEditorWorkerModuleDescription(
	"vs/workbench/contrib/notebook/common/services/notebookSimpleWorkerMain",
);
exports.workerLanguageDetection = createEditorWorkerModuleDescription(
	"vs/workbench/services/languageDetection/browser/languageDetectionSimpleWorkerMain",
);
exports.workerLocalFileSearch = createEditorWorkerModuleDescription(
	"vs/workbench/services/search/worker/localFileSearchMain",
);
exports.workerProfileAnalysis = createEditorWorkerModuleDescription(
	"vs/platform/profiling/electron-sandbox/profileAnalysisWorkerMain",
);
exports.workerOutputLinks = createEditorWorkerModuleDescription(
	"vs/workbench/contrib/output/common/outputLinkComputerMain",
);
exports.workerBackgroundTokenization = createEditorWorkerModuleDescription(
...
exports.workbenchWeb = createModuleDescription(
...
exports.code = [
	// 'vs/code/electron-main/main' is not included here because it comes in via ./Source/main.js
	// 'vs/code/node/cli' is not included here because it comes in via ./Source/cli.js
	...
	createModuleDescription(
		"vs/workbench/contrib/issue/electron-sandbox/issueReporter",
	),
	createModuleDescription(
...
exports.codeWeb = createModuleDescription(
	"vs/code/browser/workbench/workbench",
);

exports.codeServer = [
	// 'vs/server/node/server.main' is not included here because it gets inlined via ./Source/server-main.js
	// 'vs/server/node/server.cli' is not included here because it gets inlined via ./Source/server-cli.js
	createModuleDescription("vs/workbench/api/node/extensionHostProcess"),
	createModuleDescription("vs/platform/files/node/watcher/watcherMain"),
	createModuleDescription("vs/platform/terminal/node/ptyHostMain"),
];
