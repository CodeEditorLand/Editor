...
if [ -f ./Source/vscode-dts/vscode.d.ts ]; then
	echo "$header" > index.d.ts
	sed "1,4d" ./Source/vscode-dts/vscode.d.ts >> index.d.ts
	echo "Generated index.d.ts for version ${1}."
else
	echo "Can't find ./Source/vscode-dts/vscode.d.ts. Run this script at vscode root."
fi
